...
const dark = {
  ...
  rgbPrimary: '255 82 82', // Reddish primary color
  rgbAccent: '255 82 82', // Reddish accent color
  rgbText: '255 255 255',
  rgbError: '255 55 102',
...
const light = {
  ...
  rgbPrimary: '128 0 0', // Dark red primary color
  rgbAccent: '255 82 82', // Reddish accent color
  rgbText: '0 0 0', // Black text color
  rgbError: '255 0 60',
  colorTextTitle: 'rgb(var(--rgbText) / 1)',
  colorTextBody: 'rgb(var(--rgbText) / 0.8)',
  colorTextLight: 'rgb(var(--rgbText) / 0.6)',
